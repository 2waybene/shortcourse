...
#c1 <- GSA.read.gmt("cleaningData/temp.txt")
#c1 <- GSA.read.gmt("cleaningData/temp2.txt")
#c1 <- GSA.read.gmt("cleaningData/temp3.txt") # This was the Knowledge_based_gene_sets_20161005.gmt

#c1 <- GSA.read.gmt("cleaningData/temp4.txt") # This was the Knowledge_based_gene_sets_20140627.gmt
...
# Temporarily comment the following code # FIXME
...
for (i in 1:length(gsals$negative[,1])){
 ...
 #FIXME print(GSA.genescores(as.numeric(gsals$negative[,1][i]),
#FIXME                 c1$genesets, gsafit, z$GeneSymbol))
  cat("\n")
...
for (i in 1:length(gsals$positive[,1])){
 ...
 #FIXME print(GSA.genescores(as.numeric(gsals$positive[,1][i]),
#FIXME                       c1$genesets, gsafit, z$GeneSymbol))
  cat("\n")
